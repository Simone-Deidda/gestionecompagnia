...
public class TestGestioneCompagnia {
	...
	public static void main(String[] args) {
		...
		try (Connection connection = MyConnection.getConnection(Constants.DRIVER_NAME, Constants.CONNECTION_URL)) {
			...
			testFindImpiegatiByCompagnie(compagniaDAOInstance, impiegatoDAOInstance);
			System.out.println("Nella tabella Impiegato ci sono " + impiegatoDAOInstance.list().size() + " elementi.");
			testCountImpiegatiInCompagniePiuGiovsniDi(compagniaDAOInstance, impiegatoDAOInstance);
			System.out.println("Nella tabella Impiegato ci sono " + impiegatoDAOInstance.list().size() + " elementi.");
			testFindErroriAssunzione(impiegatoDAOInstance);
			System.out.println("Nella tabella Impiegato ci sono " + impiegatoDAOInstance.list().size() + " elementi.");
	...
	public static void testFindCompagniaById(CompagniaDAO compagniaDAOInstance) throws Exception {
		...
		if (!compagniaRicercata.equals(primaCompagnia))
			...
			System.out.println("testFindCompagniaById: SUCCESS");
	...
	public static void testFindImpiegatoById(ImpiegatoDAO impiegatoDAOInstance) throws Exception {
		...
		if (!impiegatoRicercato.equals(primoImpiegato))
			...
			System.out.println("testFindImpiegatoById: SUCCESS");
	...
	public static void testUpdateCompagnia(CompagniaDAO compagniaDAOInstance) throws Exception {
		...
		if (resultUpdate < 1)
			...
			System.out.println("testUpdateCompagnia: SUCCESS");
	...
	public static void testUpdateImpiegato(ImpiegatoDAO impiegatoDAOInstance) throws Exception {
		...
		if (resultUpdate < 1)
			...
			System.out.println("testUpdateImpiegato: SUCCESS");
	...
	public static void testInserimentoCompagnia(CompagniaDAO compagniaDAOInstance) throws Exception {
		...
		if (resultInsert < 1)
			...
			System.out.println("testInserimentoCompagnia : SUCCESS");
	...
	public static void testInserimentoImpiegato(ImpiegatoDAO impiegatoDAOInstance) throws Exception {
		...
		if (resultInsert < 1)
			...
			System.out.println("testInserimentoImpiegato : SUCCESS");
	...
	public static void testCancellazioneImpiegato(ImpiegatoDAO impiegatoDAOInstance) throws Exception {
		...
		if (resultDelete < 1)
			...
			System.out.println("testCancellazioneImpiegato : SUCCESS");
	...
	public static void testCancellazioneCompagnia(CompagniaDAO compagniaDAOInstance) throws Exception {
		...
		if (resultDelete < 1)
			...
			System.out.println("testCancellazioneCompagnia : SUCCESS");
	...
	public static void testFindImpiegatoByExample(ImpiegatoDAO impiegatoDAOInstance) throws Exception {
		...
		if (listaImpiegatiTrovati.size() != impiegatoDAOInstance.list().size())
			...
			System.out.println("testFindImpiegatoByExample: SUCCESS");

		// con nome inizializzato dovrebbe ritornare elementi con almeno l'iniziale
		// uguale al nome
		String iniziale = "no";
	...
	public static void testFindCompagniaByExample(CompagniaDAO compagniaDAOInstance) throws Exception {
		...
		if (listaCompagnieTrovati.size() != compagniaDAOInstance.list().size())
			...
			System.out.println("testFindCompagniaByExample: SUCCESS");
	...
	public static void testFindCompagnieByDataAssunzione(CompagniaDAO compagniaDAOInstance,
			ImpiegatoDAO impiegatoDAOInstance) throws Exception {
		System.out.println("\n<<<<<<testFindCompagnieByDataAssunzione: inizio>>>>>>");

		Impiegato primoImpiegato = impiegatoDAOInstance.list().get(0);

		List<Compagnia> listaCompagniaTrovate = compagniaDAOInstance
				.findAllByDataAssunzione(primoImpiegato.getDataAssunzione());
		if (listaCompagniaTrovate.size() < 1)
			throw new RuntimeException("testFindCompagnieByDataAssunzione : FAILED");
		else
			System.out.println("testFindCompagnieByDataAssunzione: SUCCESS");
	...
	public static void testFindCompagnieByRagioneSociale(CompagniaDAO compagniaDAOInstance) throws Exception {
		...
		List<Compagnia> listaCompagniaTrovate = compagniaDAOInstance
				.findAllByRagioneSociale(primaCompagnia.getRagioneSociale());
		if (listaCompagniaTrovate.size() < 1)
			throw new RuntimeException("testFindCompagnieByRagioneSociale : FAILED");
		else
			System.out.println("testFindCompagnieByRagioneSociale: SUCCESS");

		System.out.println("<<<<<<testFindCompagnieByRagioneSociale: fine>>>>>>\n");
	}

	public static void testFindCompagnieByCodiceFiscaleImpiegato(CompagniaDAO compagniaDAOInstance,
			ImpiegatoDAO impiegatoDAOInstance) throws Exception {
		...
		List<Compagnia> listaCompagniaTrovate = compagniaDAOInstance
				.findAllByCodiceFiscaleImpiegato(primoImpiegato.getCodiceFiscale());
		if (listaCompagniaTrovate.size() < 1)
			throw new RuntimeException("testFindCompagnieByCodiceFiscaleImpiegato : FAILED");
		else
			System.out.println("testFindCompagnieByCodiceFiscaleImpiegato: SUCCESS");

		System.out.println("<<<<<<testFindCompagnieByCodiceFiscaleImpiegato: fine>>>>>>\n");
	}

	public static void testFindImpiegatiByCompagnie(CompagniaDAO compagniaDAOInstance,
			ImpiegatoDAO impiegatoDAOInstance) throws Exception {
		System.out.println("\n<<<<<<testFindImpiegatiByCompagnie: inizio>>>>>>");

		Compagnia primaCompagnia = compagniaDAOInstance.list().get(0);

		List<Impiegato> listaImpiegatiTrovati = impiegatoDAOInstance.findAllByCompagnia(primaCompagnia);
		if (listaImpiegatiTrovati.size() < 1)
			throw new RuntimeException("testFindImpiegatiByCompagnie : FAILED");
		else
			System.out.println("testFindImpiegatiByCompagnie: SUCCESS");

		System.out.println("<<<<<<testFindImpiegatiByCompagnie: fine>>>>>>\n");
	}

	public static void testCountImpiegatiInCompagniePiuGiovsniDi(CompagniaDAO compagniaDAOInstance,
			ImpiegatoDAO impiegatoDAOInstance) throws Exception {
		System.out.println("\n<<<<<<testCountImpiegatiInCompagniePiuGiovsniDi: inizio>>>>>>");

		Compagnia primaCompagnia = compagniaDAOInstance.list().get(0);

		int totaleImpiegatiTrovati = impiegatoDAOInstance
				.countByDataFondazioneGreaterThen(primaCompagnia.getDataFondazione());
		if (totaleImpiegatiTrovati < 1)
			throw new RuntimeException("testFindImpiegatiByCompagnie : FAILED");
		else
			System.out.println("testFindImpiegatiByCompagnie: SUCCESS");
	...
	public static void testFindImpiegatiByFatturzazioneCompagnieMaggioreDi(CompagniaDAO compagniaDAOInstance,
			ImpiegatoDAO impiegatoDAOInstance) throws Exception {
		System.out.println("\n<<<<<<testFindImpiegatiByFatturzazioneCompagnieMaggioreDi: inizio>>>>>>");

		Compagnia primaCompagnia = compagniaDAOInstance.list().get(0);

		List<Impiegato> listaImpiegatiTrovati = impiegatoDAOInstance
				.findAllByCompagniaConFatturazioneMAggioreDi(primaCompagnia.getFatturatoAnnuo());
		if (listaImpiegatiTrovati.size() < 1)
			throw new RuntimeException("testFindImpiegatiByFatturzazioneCompagnieMaggioreDi : FAILED");
		else
			System.out.println("testFindImpiegatiByFatturzazioneCompagnieMaggioreDi: SUCCESS");

		System.out.println("<<<<<<testFindImpiegatiByFatturzazioneCompagnieMaggioreDi: fine>>>>>>\n");
	}

	public static void testFindErroriAssunzione(ImpiegatoDAO impiegatoDAOInstance) throws Exception {
		System.out.println("\n<<<<<<testFindErroriAssunzione: inizio>>>>>>");

		List<Impiegato> listaImpiegatiTrovati = impiegatoDAOInstance.findAllErroriAssunzione();
		if (listaImpiegatiTrovati.size() < 1)
			throw new RuntimeException("testFindErroriAssunzione : FAILED");
		else
			System.out.println("testFindErroriAssunzione: SUCCESS");

		System.out.println("<<<<<<testFindErroriAssunzione: fine>>>>>>\n");
	}
}
